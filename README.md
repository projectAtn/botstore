...
- OpenClaw auth-bypass check: `scripts/openclaw_auth_bypass_check.py`
...
- Policy SLO controller: `scripts/policy_slo_controller.py`
- Canary rollback demo: `scripts/policy_canary_rollback_demo.py`
